...
const SUGGESTED_TOPICS: SuggestedTopic[] = [
  { label: 'GreyVibe likely Russian cyberespionage campaign against Ukraine-linked military, government, civilian and business targets using AI-generated lures plus PhantomMail, PhantomClick, PrincessClub, DroneLink and Nebo attack chains (WithSecure/BleepingComputer May 28 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Nimbus Manticore (Screening Serpens/UNC1549) Iran-nexus MiniFast/MiniUpdate campaign using SEO-poisoned SQL Developer pages, trojanized Zoom installers and AppDomain hijacking against aviation, aerospace, defense, software and telecom targets (Check Point May 26 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'MuddyWater (Seedworm/Static Kitten) DLL sideloading campaign across 9 countries abusing signed Fortemedia fmapp.exe and SentinelOne sentinelmemoryscanner.exe to run ChromElevator, Node.js PowerShell reconnaissance and SOCKS5 tunneling (Symantec/Carbon Black May 26 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Lazarus Group RemotePE memory-only RAT operations targeting financial and cryptocurrency firms via Telegram social engineering, DPAPILoader, RemotePELoader, DPAPI encryption and ETW bypass (Fox-IT/The Hacker News May 25 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'TrapDoor cross-ecosystem supply chain campaign: 34+ npm, PyPI and Crates.io packages across 384+ versions stealing crypto wallets, SSH keys, cloud credentials and GitHub/AWS tokens from crypto, DeFi, Solana and AI developers (Socket/The Hacker News May 25 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Megalodon GitHub copycat worm poisoning 5,500+ repositories through fake build-bot commits, CI/CD secret theft and compromised npm packages like Tiledesk (SafeDep/TechRadar May 25 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Glassworm developer supply-chain botnet takedown by CrowdStrike, Google and Shadowserver after trojanized Open VSX extensions, npm/Python packages and 300+ poisoned GitHub repos used Solana, BitTorrent DHT, Google Calendar and VPS C2 (May 26-27 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Laravel-Lang Composer package tag hijack rewriting http-statuses, actions, attributes and lang releases to inject a cross-platform credential stealer for .env, AWS/GCP, GitHub and CI/CD secrets (May 22-24 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'ShinyHunters extortion against Charter/Spectrum: claimed 40M customer records stolen via vishing, Entra account compromise and Salesforce exfiltration; Charter confirmed incident response and notifications (May 27 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'The Gentlemen RaaS surge: NCC reports the group now accounts for roughly 10% of observed ransomware attacks, 73 April attacks and 230+ 2026 victims, targeting industrial, IT and consumer sectors (May 27 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'Silent Ransom Group (Luna Moth/UNC3753) law-firm extortion campaign escalating to in-person IT impersonation, USB drive data theft, WinSCP/Rclone exfiltration and leak-site pressure after failed remote social engineering (FBI FLASH May 26-27 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'CVE-2026-0257 Palo Alto PAN-OS/Prisma Access GlobalProtect authentication bypass actively exploited with forged authentication override cookies against VPN gateways; Rapid7 saw exploitation from May 17 and CISA KEV due June 1 (May 30 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-39987 Marimo pre-auth RCE exploited before LLM-agent post-exploitation that stole cloud credentials, retrieved an SSH key from AWS Secrets Manager and dumped an internal PostgreSQL database in under two minutes (Sysdig/The Hacker News May 29 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-48172 LiteSpeed User-End cPanel Plugin CVSS 10.0 privilege escalation actively exploited to execute scripts as root from any cPanel account on shared hosts; patch or remove affected plugin versions 2.3-2.4.4 (May 23-28 2026)', category: 'Vulnerabilities', icon: '🐛' },
];
