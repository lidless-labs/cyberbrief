...
const SUGGESTED_TOPICS: SuggestedTopic[] = [
  { label: 'OceanLotus / APT32 SPECTRALVIPER campaign against Vietnamese stock investors through FireAnt MetaKit and a transport construction firm, with domestic espionage activity tracked from 2024 through March 2026 (ESET/The Hacker News June 11 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Famous Chollima DPRK remote IT worker operations against technology firms, using AI-generated personas, deepfake interviews, forged identity documents and recruiter lures across US, European and Asian companies (CrowdStrike/TechCrunch June 10 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Handala Iran-linked California Water Service intrusion claim, 5GB data leak, RTKBase/GNSS credential exposure and billing-system access concerns after threats of follow-on disruption (SecurityWeek/Dataminr June 12 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'TA4922 China-linked phishing expansion into the UK, Germany, Italy and South Africa using HR, tax and invoice lures to deliver SilentRunLoader, RomulusLoader, Atlas RAT, AnyDesk and SyncFuture (Proofpoint/The Hacker News June 4 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Shai-Hulud / Miasma / Hades supply-chain evolution: Red Hat OIDC trusted publishing abuse, IDE configuration-file wave tied to 73 Microsoft repository disables and Hades PyPI prompt-injection evasion (Zscaler June 12 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Hades PyPI branch of Mini Shai-Hulud: 37 malicious wheels across 19 packages, Bun-powered JavaScript credential theft, .pth persistence on Python startup and GitHub/cloud/CI secret exfiltration (The Hacker News/StepSecurity June 8-9 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Awesome Motive runtime script compromise affecting OptinMonster, TrustPulse and PushEngage WordPress sites, with tampered CDN JavaScript creating rogue admin accounts and hidden backdoor plugins (Sansec/The Hacker News June 13-15 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Silent Ransom Group / Luna Moth / UNC3753 data-theft extortion against US legal, professional and financial firms using vishing, RMM tools, fake IT support visits and USB exfiltration (Google Mandiant/FBI June 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'Qilin affiliate exploitation of Check Point Remote Access VPN CVE-2026-50751, an IKEv1 authentication bypass seen since May 7 with several dozen victims and at least one ransomware deployment (Check Point/Rapid7 June 8-12 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'The Gentleman / Phantom Mantis / Larva 368 RaaS operation with 478 claimed victims, 90 percent insider-profit recruitment offers, Zeta88 tracking and reported LockBit/Qilin/Medusa/RansomHub support (PRODAFT/Cybersecurity Insiders June 12 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'CVE-2026-35273 Oracle PeopleSoft PeopleTools unauthenticated RCE exploited by ShinyHunters / UNC6240 against 100+ organizations, mainly universities, before the June 10 Oracle advisory (Oracle/Mandiant/The Hacker News June 11-12 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-20245 Cisco Catalyst SD-WAN Manager root command execution, CVE-2026-11645 Google Chromium V8 code execution and CVE-2026-7473 Arista EOS tunnel flaw added to CISA KEV together (CISA/The Hacker News June 9-10 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-50751 Check Point Remote Access VPN and Mobile Access IKEv1 auth bypass under active exploitation, CVSS 9.3, with hotfixes required for affected R80.20 through R82 deployments (Check Point/Rapid7 June 8-12 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-20253 Splunk Enterprise PostgreSQL sidecar authentication gap, CVSS 9.8, allowing unauthenticated arbitrary file create/truncate with possible RCE chaining in 10.2.x and 10.0.x (Splunk/watchTowr/Orca June 10-13 2026)', category: 'Vulnerabilities', icon: '🐛' },
];
