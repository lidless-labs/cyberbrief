...
const SUGGESTED_TOPICS: SuggestedTopic[] = [
  { label: 'UNC6508 China-linked REDCap intrusions against U.S. and Canadian medical, AI, cyber and defense research targets, using INFINITERED and Google Workspace content-compliance rules to copy email to actor-controlled inboxes (Google GTIG/The Hacker News June 16 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'ScarCruft / APT37 NarwhalRAT campaign using fake Microsoft Account security alerts, OTP-abuse lures, ZIP attachments and LNK execution to collect data from targeted victims (Genians/SC Media/The Hacker News June 16-19 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Kimsuky DPRK targeting of NGOs, think tanks, academia and North Korea policy experts with LNK phishing, GitHub, Dropbox, GitLab, VS Code tunneling, HttpSpy, PebbleDash and MoonPeak tooling (FBI FLASH/ASEC June 16 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Contagious Interview / Famous Chollima developer-recruiting lures using GitHub repositories, Cursor and VS Code project reviews to launch Linux, macOS and Windows malware loaders (Proofpoint/The Hacker News June 15 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Klue OAuth and Salesforce app compromise linked to Icarus, with Salesforce disabling the integration after customer CRM data theft hit Huntress, Recorded Future and other security firms (Huntress/BleepingComputer/SecurityWeek June 19-22 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Sapphire Sleet / BlueNoroff Mastra npm supply-chain compromise, 140+ @mastra packages backdoored through a hijacked contributor account and install-time payloads in an 88-minute campaign (Microsoft/BleepingComputer/The Hacker News June 17-22 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'JetBrains Marketplace malicious AI plugin cluster, 15 third-party IDE plugins stealing OpenAI, Anthropic and other provider API keys from developer workstations, with new uploads seen June 10 (JetBrains/Aikido/BleepingComputer June 16-17 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Shai-Hulud / Miasma / Hades package-worm activity across npm and PyPI, including 96 malicious Red Hat package versions, 37 PyPI wheels across 19 packages and AI scanner evasion behavior (Microsoft/Zscaler/Barracuda June 18-19 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'DragonForce ransomware operators using Backdoor.Turn, a Go RAT that hides command-and-control inside Microsoft Teams TURN relay traffic before data theft and encryption (BleepingComputer/The Hacker News June 18 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'The Gentlemen RaaS maintaining multiple EDR-killer tools for affiliates, extending the Phantom Mantis / Larva 368 operation beyond its 478 claimed victims and AI-assisted spread claims (BleepingComputer/PRODAFT June 18 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'Prinz Eugen ransomware operation prioritizing recently modified files for encryption and leaving no local ransom note, a new workflow reported in fresh victim telemetry (BleepingComputer June 21 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'FortiBleed credential compromise campaign exposing verified administrator credentials for 86,644 Fortinet FortiGate devices, tied to reuse after CVE-2026-24858, CVE-2025-59718 and CVE-2025-59719 (CISA/SOCRadar/The Hacker News June 19-22 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-48907 Joomla JCE improper access control flaw added to CISA KEV, enabling arbitrary PHP code execution through exposed Joomla Content Editor deployments (CISA/The Hacker News June 16-17 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-42530 and CVE-2026-42055 critical NGINX HTTP/3 and HTTP/2 module flaws patched out of band by F5, with unauthenticated use-after-free, heap overflow and possible RCE paths (F5/BleepingComputer/The Hacker News June 18-22 2026)', category: 'Vulnerabilities', icon: '🐛' },
];
