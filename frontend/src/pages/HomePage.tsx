...
const SUGGESTED_TOPICS: SuggestedTopic[] = [
  { label: 'Gamaredon (FSB/UAC-0010) GammaLoad, GammaWorm and GammaSteel campaign against Ukrainian government, military and critical infrastructure targets using WinRAR CVE-2025-8088, VBScript/PowerShell loaders, Telegram staging and NTFS Alternate Data Streams (Sekoia/Infosecurity June 1-2 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'UNC5221 / VerdantBamboo China-nexus BRICKSTORM persistence against Microsoft 365, MSP and edge-appliance environments, adding Plenet/GRIMBOLT and AgentPSD backdoors on Egnyte Storage Sync, pfSense, Synology NAS and Linux mail servers (Volexity/BleepingComputer June 5 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Operation Dragon Weave China-aligned spear-phishing against Czech and Taiwan government, research, technology and financial targets, deploying Rustcloak loader and Azureveil Adaptix C2 over Azure Blob Storage dead-drop channels (Seqrite/Dark Reading June 2 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'Black Shadow / Ababil of Minab Iran-linked destructive campaign tied to MOIS targeting LA Metro and US/Middle East transit, media, education and insurance victims, prioritizing backup destruction and recovery-system disruption over classic extortion (Gambit/Check Point June 1 2026)', category: 'APT Groups', icon: '🕵️' },
  { label: 'IronWorm npm supply-chain attack infecting 36 packages with Rust infostealer malware to steal AWS, GitHub, npm, cloud, CI/CD and AI platform secrets from 86 environment variables, with self-replication through trusted publishing (BleepingComputer/OX Security June 3-4 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'binding.gyp / node-gyp npm worm compromising @vapi-ai/server-sdk, ai-sdk-ollama and related packages via install-time hooks that steal npm, GitHub, AWS, GCP, Azure, Vault and Kubernetes secrets, inject GitHub Actions and republish from maintainer accounts (Snyk/Endor Labs June 3-4 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Hola Browser for Windows official installer/update supply-chain compromise delivering an undeclared cryptominer through the legitimate browser distribution path (BleepingComputer June 4 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Polyfill.io dormant third-party script compromise resurfacing on Toshiba, Muji, Samsung Smart TV and other sites as suspicious browser login prompts designed to harvest credentials from live web visitors (BleepingComputer June 5 2026)', category: 'Supply Chain', icon: '🔗' },
  { label: 'Silent Ransom Group / Luna Moth / UNC3753 / Chatty Spider legal-sector extortion using fake IT support calls, invoice lures, AnyDesk, Zoho Assist, Bomgar, SuperOps, WinSCP/Rclone exfiltration and occasional in-person USB theft against US law firms (FBI/Mandiant/BleepingComputer June 7 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'Qilin ransomware healthcare and hospitality surge with nine healthcare victim disclosures in 24 hours and continued high-volume leak-site activity during the first week of June (PurpleOps June 5 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'The Gentlemen ransomware / Storm-2697 affiliates using a self-propagating Go encryptor with per-file ephemeral encryption and rapid lateral movement across education, transportation, healthcare, finance and global enterprise victims (Microsoft May 28 2026)', category: 'Ransomware', icon: '💀' },
  { label: 'CVE-2026-28318 SolarWinds Serv-U uncontrolled resource consumption flaw actively exploited to crash MFT/FTP servers with unauthenticated malformed POST requests using Content-Encoding: deflate; CISA KEV deadline June 19 (CISA/BleepingComputer June 5 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-20245 Cisco Catalyst SD-WAN Manager zero-day enabling root command execution after crafted file upload, observed in limited exploitation and potentially chained with CVE-2026-20182 or CVE-2026-20127 for control-plane compromise (Cisco/BleepingComputer June 5 2026)', category: 'Vulnerabilities', icon: '🐛' },
  { label: 'CVE-2026-3300 Everest Forms Pro WordPress unauthenticated RCE actively exploited through Complex Calculation field eval() injection, allowing full site takeover on versions 1.9.12 and earlier (Wordfence/BleepingComputer June 6 2026)', category: 'Vulnerabilities', icon: '🐛' },
];
